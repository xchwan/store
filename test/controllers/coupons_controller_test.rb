...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { begin_at: @coupon.begin_at, code: @coupon.code, discount: @coupon.discount, end_at: @coupon.end_at } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { begin_at: @coupon.begin_at, code: @coupon.code, discount: @coupon.discount, end_at: @coupon.end_at } }
